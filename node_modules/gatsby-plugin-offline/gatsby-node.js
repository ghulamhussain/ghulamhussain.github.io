...
exports.onPostBuild = function (args, pluginOptions) {
  ...
  var options = {
    staticFileGlobs: [rootDir + "/**/*.{woff2}", rootDir + "/commons-*js", rootDir + "/app-*js", rootDir + "/index.html", rootDir + "/manifest.json", rootDir + "/manifest.webmanifest", rootDir + "/offline-plugin-app-shell-fallback/index.html"],
    stripPrefix: rootDir,
